...
<main>
    ...
    <div>
        ...
        {/if}
            ...
            <td style="padding-left:20px"> <Button color="secondary" style="color:white;" href="http://sos2021-27.herokuapp.com/#/graphics/line/province-budget-and-investment-in-social-promotion"> Gráfica </Button> </td>
    </div>
    <br/>
     <Table bordered>
        <thead>
