...
module.exports.register= (app,db)=>{
    ...
    app.get(BASE_API_PATH+"/azar-games-and-bet-activities", (req,res)=>{ 
        ...
        if(query.hasOwnProperty("national_lottery_expend")){
            querysParseadas["national_lottery_expend"]=query["national_lottery_expend"]
        }
        var query=req.query;
    ...
    delete query.limit;
      ...
      db.find(querysParseadas,{_id:0}).skip(offset).limit(limit).exec((err,data)=>{
        if(err){
